<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="StoreStatus.aspx.cs" Inherits="TransportManagerUI.UI.Workshop.StoreStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
  ...
  <%-- <asp:Button ID="btnNewDO" runat="server" Text="New SPR" onclick="btnNewDO_Click"  />--%>
     ...
     <asp:Button ID="btnCancel" runat="server" Text="Cancel" formnovalidate OnClick="btnCancel_Click"  />
      ...
      <asp:Panel ID="Panel7" runat="server" BackColor="White" BorderWidth="1" 
            BorderColor="Black"  GroupingText="Store Status">
 ...
 <td >
    ...
    <div style="overflow:scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
        ...
        <asp:GridView ID="gvlistofBasicData" runat="server" RowStyle-CssClass="GvGrid"
            ...
            onsorting="gvlistofBasicData_Sorting">
            ...
            <Columns>               
                <asp:BoundField DataField="ProductCode" HeaderText="Product Code" >
                    ...
                    <asp:BoundField DataField="Value" HeaderText="Total Value" >
                    <ItemStyle Width="90px" HorizontalAlign="Right"></ItemStyle>
                    </asp:BoundField >
                    <asp:BoundField DataField="Status" HeaderText="Status" 
                    SortExpression="Status" >
                    <ItemStyle width="110px" HorizontalAlign="Center" ForeColor="Red"></ItemStyle>
