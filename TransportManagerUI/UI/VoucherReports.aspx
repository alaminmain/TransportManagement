<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="VoucherReports.aspx.cs" Inherits="TransportManagerUI.UI.VoucherReports" %>
                ...
                <td valign="top">
                    <table style="color: #000000; border-style: groove; background-color: #CCFFFF; padding-left: 3px;">
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                               <asp:Panel ID="pExpenses" GroupingText="Search" runat="server">
                                   <table>
