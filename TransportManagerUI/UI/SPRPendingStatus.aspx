<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="SPRPendingStatus.aspx.cs" Inherits="TransportManagerUI.UI.Workshop.SPRPendingStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeadContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "SPRPendingStatus.aspx/PageLoad",
