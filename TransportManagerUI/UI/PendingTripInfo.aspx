<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="PendingTripInfo.aspx.cs" Inherits="TransportManagerUI.UI.PendingTripInfo" %>
            ...
            <ContentTemplate>
                <asp:Panel ID="Panel1" runat="server" ForeColor="Black" BackColor="#CCCCCC"
                    ...
                    <asp:Panel ID="Panel7" runat="server" BackColor="White" BorderWidth="1"
                        BorderColor="Black" ScrollBars="Horizontal" GroupingText="Trip Info">
