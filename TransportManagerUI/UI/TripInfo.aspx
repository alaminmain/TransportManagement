<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="TripInfo.aspx.cs" Inherits="TransportManagerUI.UI.TripInfo" %>
...
<ContentTemplate>
 ...
 <asp:AsyncPostBackTrigger ControlID="btnSearch" />
        ...
        <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" ForeColor="Black" 
             BorderStyle="Outset" BorderWidth="3px" BorderColor="Silver" GroupingText="Trip" 
        ...
        Trip No
         ...
         <td align="left" class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnSearchTC" runat="server" BackColor="#0099FF" ForeColor="Black"  Text="Select TC" OnClick="btnSearchTC_Click" />
                </td>
                <td>
<asp:HiddenField ID="hfDriverSearch" runat="server" />
                  ...
                  <ajaxToolkit:ModalPopupExtender ID="hfDriverSearch_ModalPopupExtender" 
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="hfTC_ModalPopupExtender" 
    ...
    <asp:Panel ID="plTC" runat="server" GroupingText="Search TC" BackColor="White" BorderWidth="2px">
        <asp:UpdatePanel ID="upTC" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
         <table style="width: 255px" >
                            <tr>
                            <td style="width:160px;">
                                <asp:TextBox ID="txtSearchTC" runat="server" Width="158px" />
                            </td>
                            <td style="width:90px;">
            ...
            <Columns>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:CheckBox ID="cbSelectTc" runat="server" />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField HeaderText="TCQty" DataField="totalQty" 
            ...
            <tr>
            <td>
                <asp:Button ID="btnTCProduct" runat="server" Text="Ok" OnClick="btnTCProduct_Click" Width="60px"  />
            </td>
            <td>
