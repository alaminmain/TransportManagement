<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master"
    AutoEventWireup="true" CodeBehind="VehicleAdministative.aspx.cs" Inherits="TransportManagerUI.UI.Workshop.VehicleAdministative" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeadContent" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "VehicleAdministrative.aspx/PageLoad",
        ...
        <asp:UpdatePanel ID="uplMembership" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="Panel2" runat="server"  CssClass="entry-panel">
                    <asp:Panel ID="Panel6" runat="server" GroupingText="Vehicle Administrative" CssClass="entry-panel" ForeColor="Black">
                        <table style="border: 1px solid green;">
                             <tr>
                                <td align="right" >Worktype
                                </td>
                                <td align="left" >
                                    <asp:DropDownList ID="ddlWorkType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlWorkType_SelectedIndexChanged">
                                        <asp:ListItem Value="01" Selected="True">Case</asp:ListItem>
                                        <%--<asp:ListItem Value="02">Paper Renwal</asp:ListItem>--%>
                                        <asp:ListItem Value="03">Accident</asp:ListItem>
                                        <asp:ListItem Value="04">Others</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td align="right" >Administrative ID
                                </td>
                                <td align="left" >
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtAttendDate" runat="server" Width="200px"></asp:TextBox>
                        <ajaxToolkit:CalendarExtender ID="txtAttendDate_CalendarExtender" runat="server" 
                            Format="dd/MM/yyyy" TargetControlID="txtAttendDate" />
                    </td>
                            </tr>
                            <tr>
                                <td align="right" >Sergeant Name
                                </td>
                                <td align="left" >
                                    <asp:TextBox ID="txtSergeantName" runat="server" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlStatus" runat="server" Height="24px" Width="200px">
                                        ...
                                        <asp:ListItem Text="Case Withdrawn" Value="2"></asp:ListItem>
                                       
                                        <asp:ListItem Text="Cancle" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </table>
                ...
                <tr>
                    ...
                    <td class="style142">
                        <asp:Label ID="lblDateType" runat="server" Text="Expire Date"></asp:Label>
                    </td>
                    <td>
                        Amount
                    </td>
                ...
                <asp:BoundField DataField="ItemID" HeaderText="Event ID">
                    ...
                    <ItemStyle HorizontalAlign="Left" Font-Names="sutonnymj" Font-Size="Medium" />
                    <HeaderStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="ExpDate" HeaderText="Expire Date" >
