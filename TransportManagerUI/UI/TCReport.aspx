<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="TCReport.aspx.cs" Inherits="TransportManagerUI.UI.TCReport" %>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:RadioButtonList ID="rblReports" runat="server" ForeColor="Black" OnSelectedIndexChanged="rblReports_SelectedIndexChanged" AutoPostBack="True">
                                    ...
                                    <asp:ListItem Text="TC Statement (ProductWise)" Value="TCStatmentProductWise"></asp:ListItem>
                                    <asp:ListItem Text="TC Statement" Value="TCStatement"></asp:ListItem>
