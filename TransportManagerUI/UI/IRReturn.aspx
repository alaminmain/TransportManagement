<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="IRReturn.aspx.cs" Inherits="TransportManagerUI.UI.Workshop.IRReturn" %>
    ...
    <asp:Panel ID="Panel5" runat="server">
        <asp:UpdatePanel ID="uplMembership" runat="server">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ReturnNo" HeaderText="IR Return No">
                    <ItemStyle HorizontalAlign="Center" width="120px" />
                    </asp:BoundField>
                <asp:BoundField DataField="RetDate" HeaderText="ReturnDate" 
                     />
                <asp:BoundField DataField="InternalReqNo" HeaderText="InternalReqNo">
                    <ItemStyle HorizontalAlign="Center" width="120px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="RetAmount" HeaderText="RetAmount">
                    <ItemStyle HorizontalAlign="Center" width="160px" />
                    </asp:BoundField>
                <asp:BoundField DataField="RetRemarks" HeaderText="RetRemarks" 
                    />
            </Columns>
            ...
            <SortedDescendingHeaderStyle BackColor="#4870BE" />
                ...
                <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" BorderStyle="Outset" BorderWidth="3px"
                    BorderColor="Silver" GroupingText="IR Product Return" CssClass="entry-panel">
                        ...
                        <table>
                            <tr>
                                <td class="text-right" align="right">
                                    IR Return No</td>
                                <td align="left"  >
                                    <asp:Label runat="server" ID="lblReturnNo" CssClass="IdStyle"></asp:Label>&nbsp;&nbsp;
                            ...
                            <tr>
                                ...
                                <td  align="left">
                                    <asp:TextBox ID="txtReturnDate" runat="server" TabIndex="1" Width="110px"></asp:TextBox>
                                    
                                    <ajaxToolkit:CalendarExtender ID="txtReturnDate_CalendarExtender" runat="server" BehaviorID="txtReturnDate_CalendarExtender" TargetControlID="txtReturnDate" Format="dd/MM/yyyy"/>
                                    
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right" align="right">
                                    Internal Requisition No.</td>
                                <td align="left"  >
                                    <asp:Label runat="server" ID="lblIRNo" CssClass="IdStyle"></asp:Label>&nbsp;&nbsp;
                                     <asp:ImageButton ID="btnIR" runat="server" CssClass="ImageButtonSytle" ImageUrl="~/Images/1488717192_Search.png" OnClick="btnIR_Click" />
                                    <asp:HiddenField ID="hfShowIRGrid" runat="server" />
                                    &nbsp;<ajaxToolkit:ModalPopupExtender ID="hfShowIRGrid_ModalPopupExtender" runat="server" BackgroundCssClass="modalBackground" BehaviorID="hfShowIRGrid_ModalPopupExtender" DynamicServicePath="" PopupControlID="pnIR" TargetControlID="hfShowIRGrid">
                                    </ajaxToolkit:ModalPopupExtender>
                            ...
                            <tr>
                                ...
                                <td  align="left">
                                    <asp:TextBox ID="txtIssDate" runat="server" TabIndex="1" BackColor="#66CCFF"></asp:TextBox>
                            ...
                            <td class="auto-style7">
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtTotalQTY" runat="server" Width="60px"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtTotalAMT" runat="server" Width="60px"></asp:TextBox>
                                        </td>
                ...
                <asp:Panel ID="pnIR" runat="server" BackColor="White" BorderStyle="Double" BorderWidth="3px"
                        ScrollBars="Auto">
                        <asp:UpdatePanel ID="upIR" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtIRSearch" runat="server" Width="158px" placeholder="Search" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnIRSearch" runat="server" Text="Search"
                                                formnovalidate OnClick="btnIRSearch_Click"  />
                                        </td>
                                    </tr>
                                </table>
                                <asp:GridView ID="gvIR" runat="server" AllowPaging="True" EmptyDataText="No Data To Show"
                                    GridLines="Horizontal" CellPadding="4" ForeColor="#333333" 
                                    AutoGenerateColumns="False" OnPageIndexChanging="gvIR_PageIndexChanging" OnSelectedIndexChanged="gvIR_SelectedIndexChanged" 
                                    >
                                    <AlternatingRowStyle BackColor="White" />
                                    <Columns>
                ...
                <asp:BoundField DataField="IssDate" HeaderText="IssDate" 
                    />
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnIROk" runat="server" Text="Ok" Width="60px" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnIRCancel" runat="server" Text="Cancel" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
