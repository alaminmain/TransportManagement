<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="SPR.aspx.cs" Inherits="TransportManagerUI.UI.Workshop.SPR" %>
        ...
        <asp:UpdatePanel ID="uplMembership" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" BorderStyle="Outset" BorderWidth="3px"
                    BorderColor="Silver" GroupingText="SPR" CssClass="entry-panel">
                ...
                <tr>
                    ...
                    <td class="style4" align="left">
                        <asp:TextBox ID="txtReqDate" runat="server" Width="140px"></asp:TextBox>
                           ...
                           <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlStatus" runat="server">
                                        ...
                                        <%--<asp:ListItem Text="Internal Requistion" Value="3"></asp:ListItem>
                                        <asp:ListItem Text="Vehicle Out" Value="4"></asp:ListItem>
                                        <asp:ListItem Text="Cancle" Value="5"></asp:ListItem>--%>
                                    </asp:DropDownList>
                                </td>
                                </tr>
                <tr>
            ...
            <asp:GridView ID="gvPurRequisition" runat="server" HorizontalAlign="Center" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:CheckBox ID="ck" Checked="true" runat="server"  />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EditRowStyle BackColor="#2461BF" />
