<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="Ghat.aspx.cs" Inherits="TransportManagerUI.UI.Ghat" %>
...
<ContentTemplate>
    ...
    <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click"  />
     ...
     <table >
       ...
       <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" ForeColor="Black" GroupingText="Ghat">
        ...
        <td align="right">
            Ghat Code</td>
         <td align="left">
             <asp:Label ID="lblStoreCode" runat="server" CssClass="IdStyle"></asp:Label>
        </td>
        </tr>
            ...
            <td align="right">
             ...
             <td align="left">
                 <asp:TextBox ID="txtGhat" runat="server" Width="306px" required></asp:TextBox>
