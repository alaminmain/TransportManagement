<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="FuelReports.aspx.cs" Inherits="TransportManagerUI.UI.FuelReports" %>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:RadioButtonList ID="rblReports" runat="server" ForeColor="Black" OnSelectedIndexChanged="rblReports_SelectedIndexChanged" AutoPostBack="True">
                                    ...
                                    <asp:ListItem Text="Fuel Trip Statement" Value="FuelTripStatement" Selected="True"></asp:ListItem>
