<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="HiredDriver.aspx.cs" Inherits="TransportManagerUI.UI.HiredDriver" %>
    ...
    <asp:Panel ID="Panel5" runat="server">
        <asp:UpdatePanel ID="uplMembership" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" ForeColor="Black" BorderStyle="Outset" BorderWidth="3px" BorderColor="Silver" GroupingText="Hired Driver " CssClass="entry-panel" BackColor="#FFFFCC">

                    <asp:Panel ID="Panel6" runat="server">

                        <table cellpadding="3px">
                            <tr>
                                <td align="right">&nbsp;Hired Driver Code
                                </td>
