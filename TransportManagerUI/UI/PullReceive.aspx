<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="PullReceive.aspx.cs" Inherits="TransportManagerUI.UI.PullReceive" %>
...
<ContentTemplate>
 ...
 <asp:AsyncPostBackTrigger ControlID="btnSearch" />
        ...
        <asp:Panel ID="Panel2" runat="server" GroupingText="Pull Movement" 
        ...
        <table cellpadding="3px" align="left">
          <tr>
            ...
            <td align="right" class="style1">
             ...
             <td align="left">
                 <asp:DropDownList ID="ddlStatus" runat="server" Width="200px" Enabled="False">
                     <asp:ListItem Text="Pull" Value="0"></asp:ListItem>
            ...
            <td align="right">
             ...
             <td align="left">
               <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Width="300px" Font-Names="SutonnyMJ" ></asp:TextBox>
