...
{
    public partial class SPR : System.Web.UI.Page
    {
        ...
        private DataTable LoadBasicGrid(string searchKey)
        {
            try
            {
                ...
                string sql = @"SELECT     PurRequisition.ComCode, PurRequisition.ReqNo, PurRequisition.CateCode, PurRequisition.ProdSubCatCode,CONVERT(VARCHAR(10), PurRequisition.ReqDate, 103) AS ReqDate , 
                      ...
                      ItemSubCategory ON PurRequisition.CateCode = ItemSubCategory.CateCode AND PurRequisition.ProdSubCatCode = ItemSubCategory.ProdSubCatCode order by PurRequisition.ReqDate desc,PurRequisition.ReqNo desc";
